...
<body>
	...
	<form action="modifyOk.jsp" method="post">
		<table>
			...
			<tr>
				<th>새비밀번호</th>
				<td><input type="password" name="pw" placeholder="비밀번호 수정을 원치 않으면 입력하지마세요"></td>
			</tr>
			<tr>
				<th>새비밀번호</th>
			...
			<tr>
				...
				<%-- birth가 Timestamp일경우 <input type="date" name="tempBirth" value="<%=birth==null? "":birth.toSting().substring(0, 10)%> --%>
