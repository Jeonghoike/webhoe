...
INSERT INTO FRIEND (NO, NAME, TEL, ADDRESS)
    VALUES (FRIEND_SEQ.NEXTVAL, '신길동', '010-8888-9999', '서울 마포'); -- 에러(UNIQUE) 
...
-- ex. 시퀀스 NO_SEQ 초기값 1부터 999까지 1씩 증가하는 사용:
    -- SYSDATE의 'RRMMDD' 추출 => '230728' || 시퀀스 생성수 -> '001' => '230728001'
...
SELECT TO_CHAR(SYSDATE, 'RRMMDD') || TO_CHAR(NO_SEQ.NEXTVAL, '000') FROM DUAL; -- '230728 001' 스페이스가 들어감
SELECT TO_CHAR(SYSDATE, 'RRMMDD') || TRIM(TO_CHAR(NO_SEQ.NEXTVAL, '000')) FROM DUAL; -- '230728001' 이어짐
